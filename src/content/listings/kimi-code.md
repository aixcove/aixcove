...
bodyZh: '<h2>什么是 Kimi Code？</h2>
  ...
  <li><strong>终端优先的编程代理</strong>，用于项目探索、代码编辑、命令执行和迭代调试。</li>

  <li><strong>单二进制安装</strong>，支持 macOS、Linux 和 Windows，正常使用无需 Node.js。</li>

  <li><strong>专为长时间专注代理会话设计的 TUI</strong>。</li>

  <li><strong>视频输入</strong>，可将屏幕录制或演示转化为可操作上下文。</li>

  <li><strong>MCP、技能、钩子和子代理</strong>，用于扩展工作流、连接工具，并将任务拆分为聚焦的并行子任务。</li>

  <li><strong>ACP 编辑器集成</strong>，让 Zed 或 JetBrains 等兼容编辑器可以驱动 Kimi Code 会话。</li>

  </ul>

  <h2>谁适合使用 Kimi Code？</h2>

  <p>Kimi Code 适合那些想要轻量级命令行编程代理、而非完整 IDE 的开发者。对于正在测试 Kimi Code模型的团队、偏好终端工作流的开发者，以及希望使用 MCP、钩子、子代理和技能而不想从零搭建自定义代理栈的用户来说，它是一个实用的选择。</p>

  <h2>定价与访问</h2>

  <p>Kimi Code 以 MIT 许可证发布。使用时，通过 Kimi Code OAuth 登录，或配置 Moonshot AI 开放平台 API 密钥。API 和模型使用费用取决于所选的 Moonshot AI 套餐或兼容提供商。</p>

  <h2>官方链接</h2>

  <ul>

  <li><a href="https://moonshotai.github.io/kimi-code/" rel="nofollow noopener" target="_blank">Kimi Code 文档</a></li>

  <li><a href="https://github.com/MoonshotAI/kimi-code" rel="nofollow noopener" target="_blank">Kimi Code GitHub 仓库</a></li>
